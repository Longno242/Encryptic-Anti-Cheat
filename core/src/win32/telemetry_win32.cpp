...
std::string violation_type_name(anticheat::ViolationType type) {
    ...
    case anticheat::ViolationType::ThreatToolDetected: return "threat_tool";
    case anticheat::ViolationType::InjectionDetected: return "injection";
    case anticheat::ViolationType::BypassDetected: return "bypass";
    case anticheat::ViolationType::KnownCheatHash: return "known_cheat_hash";
    case anticheat::ViolationType::SuspiciousPipe: return "suspicious_pipe";
    case anticheat::ViolationType::KernelDriverUnavailable: return "kernel_driver_unavailable";
