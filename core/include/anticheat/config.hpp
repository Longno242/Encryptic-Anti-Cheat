...
struct Config {
    ...
    bool threat_intel_guard{true};
    bool injection_guard{true};
    bool anti_bypass_guard{true};
    bool hash_guard{true};
    bool pipe_guard{true};
    bool kernel_guard{false};
    bool vm_guard{false};
    ...
    bool kernel_protect_handles{true};
    bool kernel_block_drivers{true};
    bool kernel_block_modules{true};
    bool kernel_block_global_cheats{false};
    std::uint32_t kernel_poll_interval_ms{1000};
    std::string kernel_device_path{"\\\\.\\EncrypticGuard"};
    ...
    std::uint32_t threat_intel_scan_interval_ms{5000};
    std::uint32_t injection_scan_interval_ms{6000};
    std::uint32_t anti_bypass_scan_interval_ms{4000};
    std::uint32_t hash_scan_interval_ms{20000};
    std::uint32_t pipe_scan_interval_ms{7000};
    ...
    std::vector<std::string> blocked_window_classes;
    std::vector<std::string> blocked_window_titles;
    std::vector<std::string> blocked_path_segments;
    std::vector<std::string> blocked_drivers;
    std::vector<std::string> blocked_pipes;
    std::vector<std::string> blocked_mutexes;
    std::vector<CheatHashEntry> known_cheat_hashes;
