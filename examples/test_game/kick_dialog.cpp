...
std::wstring friendly_headline(const anticheat::Violation& v) {
    ...
    case anticheat::ViolationType::ThreatToolDetected:
        return L"Advanced cheat tool detected";
    case anticheat::ViolationType::InjectionDetected:
        return L"Injection or suspicious loader detected";
    case anticheat::ViolationType::BypassDetected:
        return L"Anti-cheat bypass attempt detected";
    case anticheat::ViolationType::KnownCheatHash:
        return L"Known cheat binary detected";
    case anticheat::ViolationType::SuspiciousPipe:
        return L"Cheat tool IPC channel detected";
    case anticheat::ViolationType::KernelDriverUnavailable:
        return L"Kernel driver not loaded";
...
std::wstring detection_badge(const anticheat::Violation& v) {
    ...
    case anticheat::ViolationType::ThreatToolDetected: return L"THREAT INTEL";
    case anticheat::ViolationType::InjectionDetected: return L"INJECTION GUARD";
    case anticheat::ViolationType::BypassDetected: return L"ANTI-BYPASS";
    case anticheat::ViolationType::KnownCheatHash: return L"HASH GUARD";
    case anticheat::ViolationType::SuspiciousPipe: return L"PIPE GUARD";
    case anticheat::ViolationType::KernelDriverUnavailable: return L"KERNEL GUARD";
