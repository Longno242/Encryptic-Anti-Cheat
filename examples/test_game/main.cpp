...
const char* violation_type_name(anticheat::ViolationType type) {
    ...
    case anticheat::ViolationType::ThreatToolDetected: return "ThreatToolDetected";
    case anticheat::ViolationType::InjectionDetected: return "InjectionDetected";
    case anticheat::ViolationType::BypassDetected: return "BypassDetected";
    case anticheat::ViolationType::KnownCheatHash: return "KnownCheatHash";
    case anticheat::ViolationType::SuspiciousPipe: return "SuspiciousPipe";
    case anticheat::ViolationType::KernelDriverUnavailable: return "KernelDriverUnavailable";
